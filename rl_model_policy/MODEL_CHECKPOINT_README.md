...
target_y:
  normalized bounding-box bottom y in [0, 1], 0 when target is not visible
...
nearest_avoid_x, nearest_avoid_y:
  center x and bottom y of the closest avoid object in normalized camera coordinates,
