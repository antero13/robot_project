...
def generate_launch_description():
    ...
    policy_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "aligned_approach_enabled": aligned_approach_enabled,
            "aligned_approach_linear_x": aligned_approach_linear_x,
            "aligned_approach_angular_gain": aligned_approach_angular_gain,
            "aligned_approach_max_angular_z": aligned_approach_max_angular_z,
