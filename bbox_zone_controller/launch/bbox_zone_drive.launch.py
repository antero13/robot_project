...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("straight_linear_x", default_value="0.06"),
        DeclareLaunchArgument("avoid_turn_linear_x", default_value="0.05"),
        DeclareLaunchArgument("avoid_turn_angular_z", default_value="0.25"),
        DeclareLaunchArgument("target_forward_linear_x", default_value="0.10"),
