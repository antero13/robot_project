    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'y_correction_topic': LaunchConfiguration('y_correction_topic'),
                'yaw_correction_topic': LaunchConfiguration(
                    'yaw_correction_topic'
                ),
                'position_lock_topic': LaunchConfiguration(
                    'position_lock_topic'
                ),
