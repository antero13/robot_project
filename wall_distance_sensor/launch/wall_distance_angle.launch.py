                ...
                parameters=[
                    {
                        ...
                        "timing_budget_us": ParameterValue(
                            LaunchConfiguration("timing_budget_us"),
                            value_type=int,
                        ),
                        "inter_measurement_period_ms": ParameterValue(
                            LaunchConfiguration("inter_measurement_period_ms"),
                            value_type=int,
                        ),
